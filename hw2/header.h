...
#define L_MEM_DIR_NAME "index" // /sys/devices/system/cpu/cpu0/cache 아래에 memory 정보가 들어있는 dir 이름
#define L_MEM_LEVEL "level"
#define L_MEM_TYPE "type"
#define L_MEM_SIZE "size"
...
// /proc/cpuinfo 에서의 row idx
enum CPUINFO{
	CPUINFO_PROCESSOR = 0 // 0
	, CPUINFO_VENDOR_ID
	, CPUINFO_CPU_FAMILY 
	, CPUINFO_MODEL 
	, CPUINFO_MODEL_NAME 
	...
	, CPUINFO_CPU_CORES 
	, CPUINFO_APICID
	, CPUINFO_INITIAL_APICID
	, CPUINFO_FPU
	, CPUINFO_FPU_EXCEPTION
	, CPUINFO_CPUID_LEVEL
	, CPUINFO_WP
	, CPUINFO_FLAGS 
	, CPUINFO_BOGOMIPS
	, CPUINFO_CLFLUSH_SIZE
	, CPUINFO_CACHE_ALIGNMENT
	, CPUINFO_ADDRESS_SIZE
	, CPUINFO_POWR_MANAGE
};
...
#define CPUMODE "CPU op-mode(s)"
#define BYTEORDER "Byte Order"
#define CPUS "CPUS(S)"
#define ONLINECPUS "On-line CPU(s) list"
#define THREAD_PER_CORE "Thread(s) per core"
#define CORE_PER_SOCKET "Core(s) per socket"
#define SOCKET_CNT "Socket(s)"
#define NUMA_MODE "NUMA node(s)"
#define VENDOR_ID "Vendor ID"
#define CPU_FAMILY "CPU family"
#define MODEL_CNT "Model"
#define MODEL_NAME "Model name"
#define STEPPING "Stepping"
#define CPU_MHZ "CPU MHz"
#define MIPS "BogoMIPS"
#define HYPER_VENDOR "Hypervisor vendoor"
#define VIRTUAL_TYPE "Virtualization type"
#define L1D_CACHE "L1d cache"
#define L1I_CACHE "L1i cache"
#define L2_CACHE "L2 cache"
#define L3_CACHE "L3 cache"
#define CPUS_IN_NUMA_NODE "NUMA node0 CPU(s)"
#define FLAGS "Flags"
